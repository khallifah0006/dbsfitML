...
MODEL_PATH = os.environ.get('MODEL_PATH', 'model_olahraga54.h5')
SCALER_PATH = os.environ.get('SCALER_PATH', 'scaler54.pkl')
LABEL_ENCODER_PATH = os.environ.get('LABEL_ENCODER_PATH', 'label_encoder54.pkl')
MLB_PATH = os.environ.get('MLB_PATH', 'mlb54.pkl')

class WorkoutRecommendationSystem:
    def __init__(self, model_path=MODEL_PATH, scaler_path=SCALER_PATH, 
                 label_encoder_path=LABEL_ENCODER_PATH, mlb_path=MLB_PATH):
        """
...
if __name__ == '__main__':
    ...
    print(f"Recommendation endpoint: http://localhost:{port}/api/recommend")
